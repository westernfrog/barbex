  ...
  return (
    <>
      ...
      <section className="absolute inset-0 z-0 overflow-hidden">
        ...
        <button
          onClick={prevSlide}
          className="absolute top-1/2 left-10 transform -translate-y-1/2 ring-1 ring-primary hover:bg-primary hover:text-white text-primary p-2 rounded-full transition duration-300 ease-in-out"
        >
          <ArrowLeftIcon />
        </button>
        <button
          onClick={nextSlide}
          className="absolute top-1/2 right-10 transform -translate-y-1/2  ring-1 ring-primary hover:bg-primary hover:text-white text-primary p-2 rounded-full transition duration-300 ease-in-out"
        >
          <ArrowRightIcon />
        </button>
